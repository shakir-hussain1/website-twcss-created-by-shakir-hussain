...
const Contact = () => {
  return (
    <section className="contact-form border max-w-lg mx-auto my-20 p-8 bg-red-500 shadow-md rounded-md">
      ...
      <form>
        ...
        <button type="submit" className="w-full bg-gray-500 text-black py-2 rounded-md">Send Message</button>
      </form>
    </section>
  );
};
