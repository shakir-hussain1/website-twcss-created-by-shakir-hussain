...
const Header = () => {
  ...
  return (
    <header className="bg-blue-800 text-black py-5 flex justify-between items-center px-10 relative z-10">
      <h1 className="text-2xl font-bold">Techmaa Laptop Store</h1>
